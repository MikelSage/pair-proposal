...
ActiveRecord::Schema.define(version: 20170722001542) do
  ...
  create_table "arrangements", force: :cascade do |t|
    ...
    t.index ["tutor_date_id"], name: "index_arrangements_on_tutor_date_id"
  ...
  add_foreign_key "arrangements", "tutor_dates"
